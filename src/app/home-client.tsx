...
export default function HomeClient() {
  ...
  useEffect(() => {
    // Get username from Base App context
    // This will show the username of the user currently using the miniapp
    if (context) {
      console.log("Base App Context:", context);
      
      // Try to get username from different possible locations in context
      const foundUsername = 
        context.user?.username ||           // Current user's username
        context.user?.displayName ||        // Fallback to display name
        null;
      ...
      if (foundUsername) {
        ...
        console.log("⚠️ No username found in context, using default 'username'");
        // Keep default "username" if not found
      }
    } else {
      console.log("⚠️ Context not available yet");
    }
  }, [context]);
